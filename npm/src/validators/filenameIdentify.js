...
function findRuleMatches(schema, context) {
    ...
    if (context.filenameRules.length === 0 &&
        ...
        if (context.file.name === "dataset_description.json") {
            ...
            context.issues.addSchemaIssue("WrongMetadataLocation", [context.file], `You have placed a file called "dataset_description.json" within the ${context.baseDir} 
