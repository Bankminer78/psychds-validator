 ...
 */
export async function loadSchema(version = 'latest') {
    const versionRegex = /\d+.\d+.\d+/;
    let schemaUrl = version;
    const psychdsSchema = typeof dntShim.Deno !== 'undefined' ? dntShim.Deno.env.get('psychDS_SCHEMA') : undefined;
    ...
    try {
        ...
        return new Proxy(schemaDefault, objectPathHandler);
    }
}
